...
Route::get('certificate/{participantId}', 'Backend\QuizController@getCertificate')->name('getCertificate');
// });
...
Route::group(['prefix' => 'management', 'middleware' => 'isauthuser'], function(){
    ...
    Route::prefix('quiz')->group(function () {
        ...
        Route::get('leaderboard', 'Backend\QuizController@getLeaderboard');
        Route::get('leaderboard/certificate/{participantId}', 'Backend\QuizController@getCertificate')->name('getCertificate');
    });
